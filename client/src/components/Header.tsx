...
const Header: FC<HeaderProps> = ({ onSettingsClick, onBackToMenuClick }) => {
  return (
    <header className="relative z-10 py-4 px-6 flex justify-between items-center">
      ...
      <div className="flex space-x-3">
        <button
          ...
          className="px-3 py-2 rounded-lg bg-slate-800/80 flex items-center justify-center hover:bg-slate-700/80 transition-colors"
